...
class Model:
    ...
    def __init__(self):
        ...
        self.bDry = False
            # Logging
        self.bLogging = False
        self.sDateiLogging = os.path.expanduser("~") + "/ingest.log"
            # Sicht auf die Daten
        ...
        self.prnt = SmartPrint(model = self)
            # Infos zum Programm
        self.sInfoPrgName = "Ingest"
        self.sInfoPrgVersion = "v.0.9.3~"
        self.sInfoDbSchemaVersion = "edna"
        self.sInfoDatum = u"Copyright \N{COPYRIGHT SIGN} 2017"
        self.sInfoKommentar = "Dieses Programm hilft bei der massenweisen Ingestion von Excel-Dateien in eine Datenbank."
        ...
        self.sConfigFilename = os.path.expanduser("~") + "/ingest.conf"
        self.cfgRead()
            # Workflows
